...
class CourseBookingManager:
    ...
    def get_course_selection_message(self):
        ...
        return (
            "మీరు ఏ course నుండి interested ఉంటారు?"
            "We offer two main courses:"
            "1. Python Full Stack - 8 weeks, 12,000 INR (after discount)"
            "2. Java Full Stack - 10 weeks, 14,000 INR (after discount)."
    ...
    def get_course_confirmation(self, course_name):
        ...
        return (
            ...
            f"ఈ course about free demo class ఉంది -"
            f"next batch {course['next_batch']} నుండి start అవుతుంది బ్రో. "
            f"Free demo class నీ convenient day లో చేయవచ్చు."
            f"Demo లో live coding, actual mentors, and doubts clarification ఉంటుంది."
            f"మీరు free demo class కి interested ఉంటారా? Yes or no?"
        )
    ...
    def get_demo_booking_message(self, course_name):
        ...
        if not course:
            return (
                f"కూల్! మీ slot book చేసుకోవడానికి ఇదిగో free demo options ఉన్నాయి."
                f"Available days: {days_str}."
                f"దయచేసి Monday, Tuesday, Wednesday, Thursday లేదా Friday లో ఒకటి చెప్పండి."
            )
        
        return (
            f"కూల్! నీ demo slot book చేస్తానా?"
            f"Available days: {days_str}."
            f"నీకు ఏ day convenient? Please say Monday, Tuesday, Wednesday, Thursday, or Friday."
        )
    ...
    def get_demo_time_message(self):
        ...
        return (
            ...
            "మీకు ఏ time convenient? Please say the time."
        )
    ...
    def get_closing_message(self, booking):
        ...
        return (
            f"ధన్యవాదాలు! మీ booking confirmed!"
            f"Course: {booking['course_name']} బ్రో, "
            f"Demo Date: {booking['demo_date']} బ్రో, "
            f"Demo Time: {booking['demo_time']} బ్రో. "
            f"ఈ details మీ phone కి message లో కూడా పంపిస్తాం."
            f"Demo లో చూపించేవి చాలా exciting ఉంటుంది."
            f"See you soon! All the best for your bright future!"
        )
